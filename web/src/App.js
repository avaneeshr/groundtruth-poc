...
const MAP_URL = document.querySelector('#document-image').innerText.trim();
...
const Iframe = ({ source }) => {
  ...
  const src = source;     
  return (
      <div width="1200" height="450" >
          <div className="emdeb-responsive">
              <iframe src={src} width="1200" height="450" ></iframe>
          </div>
      </div>
  );
};
